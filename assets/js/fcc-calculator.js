...
( function () {
	...
	if ( VoiceRecognition && voiceBtn && features.voice_search !== false ) {
		...
		if ( iconEl ) {
			if ( vIcon === 'svg' ) iconEl.innerHTML = '<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#fff" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="9" y="1" width="6" height="14" rx="3"/><path d="M5 10v1a7 7 0 0014 0v-1"/><line x1="12" y1="18" x2="12" y2="23"/></svg>';
