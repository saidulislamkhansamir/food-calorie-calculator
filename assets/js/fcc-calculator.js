	...
	if ( printBtn ) {
		printBtn.addEventListener( 'click', function () {
			...
			printFooter.innerHTML =
				...
				+ '🔍 Calculate nutrition for any food at <a href="https://foodcaloriecalculator.co.uk" style="color:#fff;text-decoration:underline;font-weight:700;">foodcaloriecalculator.co.uk</a>'
				+ '</div>'
