      ...
      <body>
        ...
        <header class="sm-header">
          <div class="sm-header__inner">
                        <div class="sm-header__icon"><img src="https://foodcaloriecalculator.co.uk/wp-content/uploads/2026/07/Food-Calorie-Calculator-Logo-Icon-5.png" width="52" height="52" alt="Food Calorie Calculator" style="display:block;border-radius:10px;"/></div>
            <div>
              <xsl:choose>
                <xsl:when test="sm:sitemapindex">
        ...
        <div class="sm-footer">
          ...
          &#xB7; Powered by <a href="https://thekhandigital.com" target="_blank">The Khan Digital</a>
        </div>
