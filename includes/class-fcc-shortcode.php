...
#fcc-calculator .fcc-search-icon{position:absolute!important;left:0.9rem!important;right:auto!important;top:50%!important;bottom:auto!important;transform:translateY(-50%)!important;pointer-events:none!important;display:flex!important;align-items:center!important;z-index:2!important;color:#148B43!important;}
...
#fcc-calculator .fcc-voice-btn{position:absolute!important;right:1.25rem!important;left:auto!important;top:50%!important;bottom:auto!important;transform:translateY(-50%)!important;z-index:10!important;margin:0!important;width:30px!important;height:30px!important;min-width:0!important;min-height:0!important;max-width:30px!important;max-height:30px!important;border-radius:50%!important;display:flex!important;align-items:center!important;justify-content:center!important;background:#148B43!important;color:#fff!important;border:none!important;box-shadow:0 2px 6px rgba(20,139,67,.3)!important;flex-shrink:0!important;}
...
#fcc-calculator .fcc-share-icon:not(:first-child)::before{content:""!important;position:absolute!important;top:0!important;left:0!important;bottom:0!important;width:1.5px!important;background:#d0d7d2!important;pointer-events:none!important;}
...
#fcc-calculator .fcc-action-btn--primary,#fcc-calculator .fcc-add-to-meal,#fcc-calculator button.fcc-add-to-meal,#fcc-calculator button.fcc-add-to-meal--action,#fcc-calculator .fcc-add-to-meal--action{background:#FF3F33!important;color:#fff!important;border:1.5px solid #FF3F33!important;box-shadow:0 2px 8px rgba(255,63,51,.25)!important;border-radius:8px!important;padding:0.42rem 0.85rem!important;font-size:0.82rem!important;font-weight:600!important;min-height:0!important;height:auto!important;line-height:1.4!important;display:inline-flex!important;align-items:center!important;box-sizing:border-box!important;}
#fcc-calculator .fcc-action-btn--primary:hover,#fcc-calculator .fcc-add-to-meal:hover,#fcc-calculator .fcc-add-to-meal--action:hover{background:#e63529!important;border-color:#e63529!important;}
...
/* Saved template chips — label + chips on one line, centred */
#fcc-calculator .fcc-meal-templates{display:flex!important;align-items:center!important;flex-wrap:wrap!important;gap:6px!important;padding:0.75rem 1rem 0!important;}
#fcc-calculator .fcc-meal-templates__label{margin:0!important;flex-shrink:0!important;}
#fcc-calculator .fcc-meal-templates__list{display:contents!important;}
...
#fcc-calculator .fcc-meal-tpl-chip--active .fcc-meal-tpl-chip__del{border-left-color:rgba(255,255,255,.2)!important;color:rgba(255,255,255,.6)!important;}
...
#fcc-calculator .fcc-meal-item__qty{width:56px!important;min-width:0!important;max-width:56px!important;box-sizing:border-box!important;}
...
@media(max-width:767px){#fcc-calculator .fcc-compare-grid{grid-template-columns:1fr!important;}}
	...
	public function maybe_enqueue_style_early(): void {
		...
		$settings   = Settings::get_all();
		$appearance = $settings['appearance'] ?? [];
		$custom_props = ':root{--fcc-primary:' . esc_attr( $appearance['primary_colour'] ?? '#21BA5F' )
	...
	public static function enqueue_public_assets(): void {
		...
		if ( ! $inline_added ) {
			$custom_props = sprintf(
				...
				esc_attr( $appearance['primary_colour']    ?? '#21BA5F' ),
		...
		wp_localize_script(
			...
			[
				...
				'appearance'  => [
					...
					'voiceColour'        => esc_attr( $appearance['voice_colour']         ?? '#21BA5F' ),
