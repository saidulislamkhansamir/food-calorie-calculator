	...
	<div class="fcc-tabs-body">
		...
		<div class="fcc-tab-panel" data-panel="calculator">
			...
			<section class="fcc-section fcc-search-section" aria-label="<?php esc_attr_e( 'Food search', 'food-calorie-calculator' ); ?>">
				<div class="fcc-search-wrapper">
					...
					<div class="fcc-autocomplete" role="combobox" aria-expanded="false" aria-haspopup="listbox" aria-owns="fcc-search-results">
						...
						<button type="button" class="fcc-voice-btn" id="fcc-voice-btn" hidden
							aria-label="<?php esc_attr_e( 'Search by voice', 'food-calorie-calculator' ); ?>"
							title="<?php esc_attr_e( 'Search by voice', 'food-calorie-calculator' ); ?>">
							<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#ffffff" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><path d="M12 1a3 3 0 00-3 3v8a3 3 0 006 0V4a3 3 0 00-3-3z"/><path d="M19 10v2a7 7 0 01-14 0v-2"/><line x1="12" y1="19" x2="12" y2="23"/><line x1="8" y1="23" x2="16" y2="23"/></svg>
						</button>
			...
			<section class="fcc-section fcc-results-section" aria-label="<?php esc_attr_e( 'Nutrition results', 'food-calorie-calculator' ); ?>" hidden aria-live="polite">
				...
				<div class="fcc-result-actions fcc-result-actions--v2">

					<!-- Row 1: Primary actions -->
					<div class="fcc-actions-primary">
						<?php if ( ! empty( $features['print_pdf'] ) ) : ?>
						<button type="button" class="fcc-action-btn fcc-action-btn--outline fcc-print-btn">
						...
						<button type="button" class="fcc-action-btn fcc-action-btn--ghost fcc-copy-nutrition-btn" hidden>
						...
						<button type="button" class="fcc-action-btn fcc-action-btn--ghost fcc-favourite-btn" hidden>
							<span class="fcc-favourite-icon">&#9825;</span>
							<span class="fcc-favourite-label"><?php esc_html_e( 'Save', 'food-calorie-calculator' ); ?></span>
						</button>

						<?php if ( $has_compare ) : ?>
						<button type="button" class="fcc-action-btn fcc-action-btn--ghost fcc-compare-shortcut-btn" hidden>
					...
					<!-- Row 2: Share & social -->
					<div class="fcc-actions-share">
						<span class="fcc-actions-share__label"><?php esc_html_e( 'Share:', 'food-calorie-calculator' ); ?></span>
						<div class="fcc-share-group" hidden>
							<?php if ( ! empty( $features['share_link'] ) ) : ?>
							<button type="button" class="fcc-share-icon fcc-share-icon--link fcc-share-btn" title="<?php esc_attr_e( 'Copy Link', 'food-calorie-calculator' ); ?>">
							...
							<?php endif; ?>
							<button type="button" class="fcc-share-icon fcc-share-icon--email" data-channel="email" title="Email">
								<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"/><polyline points="22,6 12,13 2,6"/></svg>
							</button>
							<button type="button" class="fcc-share-icon fcc-share-icon--whatsapp" data-channel="whatsapp" title="WhatsApp">
							...
							<button type="button" class="fcc-share-icon fcc-share-icon--facebook" data-channel="facebook" title="Facebook">
								<svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/></svg>
							</button>
							<button type="button" class="fcc-share-icon fcc-share-icon--x" data-channel="x" title="X">
								<svg width="13" height="13" viewBox="0 0 24 24" fill="currentColor"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/></svg>
							</button>
							<button type="button" class="fcc-share-icon fcc-share-icon--linkedin" data-channel="linkedin" title="LinkedIn">
								<svg width="13" height="13" viewBox="0 0 24 24" fill="currentColor"><path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433a2.062 2.062 0 01-2.063-2.065 2.064 2.064 0 112.063 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z"/></svg>
							</button>
							<button type="button" class="fcc-share-icon fcc-share-icon--reddit" data-channel="reddit" title="Reddit">
